   ...
   var successMessages = {
        ...
        PasswordForgot: "Email has been sent to your provided email address, please check your email for further instructions",
...
//    }
    ...
    lr_raas_settings.forgotpassword.success = function (response, data) {
        if(response.IsPosted && response.Data && response.Data.AccountSid){
            ...
            if (raasoption.phoneLogin && !data.email){
               setMessage(successMessages.PasswordReset);  
               showLogin();
            }
            else {
