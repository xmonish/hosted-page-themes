...
// raasoption.integrationName = ''; /* your jwt app name */
 ...
 jQuery(".lr-register-link").click(showRegister);
 	...
 	$(".lr-back-link").on('click', function() {
        $(".lr-form-frame").hide();
		$("#mainScreen").show();
	});

 	$(".button, input[type='submit']").on('click', function() {
		 ht = $(".wrapper").height()+35;                                                           
         lrPostMessage("Change Size", 'success', {height:ht});                                                   
                                                            
	});												 

		
 function showForgotPassword() {
    $("#mainScreen, #lr-traditional-login,#lr-raas-registartion,#resetpassword-container,#lr-social-login,#lr-raas-resetpassword").hide();
 ...
 function showLogin() {
	...
	$(".linksignin-loginradius-email-me-a-link-to-sign-in,.otpsignin-loginradius-send-an-otp-to-sign-in").hide();
	$( 'label[for="loginradius-login-password"]').replaceWith( '<label for="loginradius-login-password">Password<a class="lr-raas-forgot-password">Forgot password?</button></a>' );
	 
	$(".lr-raas-forgot-password").on('click', function() {
        $(".lr-form-frame").hide();
		$("#lr-raas-forgotpassword").show();
		 ht = $(".wrapper").height()+35;                                                           
         lrPostMessage("Change Size", 'success', {height:ht});                                                                                                  																						 
 ...
 function showRegister() {
    $("#mainScreen, #lr-traditional-login,#lr-raas-forgotpassword,#resetpassword-container,#lr-raas-sociallogin,#lr-raas-resetpassword").hide();
